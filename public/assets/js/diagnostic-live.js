(function () {
  ...
  function renderHistory(items) {
    ...
    if (!list) return;
    if (!items.length) {
      list.innerHTML = `<div class="dx-history-empty">No saved tests yet.<br>Run a <strong>Test</strong> or Programmed suite from Overview — results stay on this PC.</div>`;
      return;
    }
