...
class DiagnosticService
{
    ...
    private function extractMetrics(array $normalized): array
    {
        ...
        return [
            ...
            'gpu_hotspot_source' => (string) ($normalized['sensors']['gpu_hotspot_source'] ?? $gpu['hotspot_source'] ?? ''),
            'gpu_therm_spread' => (float) ($normalized['sensors']['gpu_therm_spread'] ?? $gpu['therm_spread'] ?? 0),
            'gpu_vram_temp' => (float) ($normalized['sensors']['gpu_vram_temp'] ?? $gpu['vram_temp'] ?? 0),
