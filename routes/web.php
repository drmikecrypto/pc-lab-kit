...
$router->post('/api/verify/pclab', fn () => $verify->verifyPayload());
...
$router->get('/download/probe-linux', fn () => $downloads->probeLinux());
...
$router->post('/api/diagnostic/suite/plan', fn () => $api->diagnosticSuitePlan());
$router->post('/api/diagnostic/platform/audit', fn () => $api->diagnosticPlatformAudit());
...
$router->get('/api/diagnostic/suite/resumable', fn () => $api->diagnosticSuiteResumable());
$router->post('/api/diagnostic/suite/cancel/{id}', fn (string $id) => $api->diagnosticSuiteCancel($id));
$router->post('/api/diagnostic/suite/discard/{id}', fn (string $id) => $api->diagnosticSuiteDiscard($id));
