...
**Shipped in v4.2.3.0:** CapFrameX-lite **Session Review** — persisted PresentMon artifacts, FPS histogram, 1%/0.1%/P99 strip, stutter spike list, A/B session compare, CapFrameX JSON import into the same list (`/presentmon/sessions*`). Historical desktop note **4.3.0** (superseded by unified **4.2.4+**).
