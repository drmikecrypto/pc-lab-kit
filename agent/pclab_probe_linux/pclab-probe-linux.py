            ...
            self._send(
                200,
                {
                    ...
                    "honesty": {
                        ...
                        "sensors": True,
                        "benches": True,
                        "lcd_oem_plugins": "partial",
                        "note": "hwmon/sysfs + optional nvidia-smi/smartctl — no Ring0; Phase 3 expands RGB/LCD subset",
                    },
                    "roadmap": {
                        "linux_parity": "0.6.x–0.9.x",
                        "oem_lcd": "selective",
                        "exit_1_0": "docs/MASTER_PLAN.md#phase-4--10-declaration",
                    },
                },
            )
            return
